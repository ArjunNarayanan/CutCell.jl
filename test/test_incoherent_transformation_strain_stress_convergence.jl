...
@test allapprox(s11rate,repeat([2.0],length(s11rate)),0.15)
@test allapprox(s22rate,repeat([2.0],length(s11rate)),0.15)
@test allapprox(s12rate,repeat([2.0],length(s11rate)),0.15)
@test allapprox(s33rate,repeat([2.0],length(s11rate)),0.15)
